...
{
    public RuntimeContext(ContentManager content, GraphicsDevice graphicsDevice, SpriteBatch spriteBatch, EntityWorld world, OrthographicCamera camera, GameDataRepository gameData)
    {
