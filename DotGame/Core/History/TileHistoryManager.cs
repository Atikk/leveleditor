...
{
    // Legacy UI-side copy — renamed to avoid conflict with the canonical core implementation.
    [System.Obsolete("UI-local TileHistoryManager has been superseded by DotGame.Core.TileHistoryManager. This type exists only for compatibility.")]
